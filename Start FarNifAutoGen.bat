...
REM set "NIF_JOBLIST_FILE=nif_list_vurt_ashland_trees.job"
REM set "NIF_JOBLIST_FILE=nif_list_vurt_bc_trees.job"
REM set "NIF_JOBLIST_FILE=nif_list_testing.job"

set "NIF_REDUCTION_SCALE=0.50"
